...
> Type "Grab ITEM"
You have grabbed X save it for later

> Type "Look"
Exits: WEST NORTH

> Type "Map"
Visited 1 of 6 rooms
id name (visited)
id2 name2
id3 name3

// Add Color coordination to console printing
// items can be red
// room name Purple
// direction statements green | ex. to the north
// Make hashmap instead of arraylist
// add player class
