    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (action) {
                ...
                case "n", "north" -> Player.getPlayer().movePlayer("N");
                case "e", "east" -> Player.getPlayer().movePlayer("E");
                case "s", "south" -> Player.getPlayer().movePlayer("S");
                case "w", "west" -> Player.getPlayer().movePlayer("W");

                // // EXPLORE: Lists any items currently in the room.
                case "explore" -> Player.getPlayer().explore();
                ...
                case "inventory" -> Player.getPlayer().showInventory();

                // PLAYERSTATS: Displays the player's current/max health
                case "playerstats", "stats" -> Player.getPlayer().showPlayerStats();
