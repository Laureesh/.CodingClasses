 ...
 *
 * Description:
 * Handles player movement, exploration, health, and inventory actions
 * like picking up, inspecting, dropping, and using items.
 */
public class Player {
    // Keeps track of the one active player
    ...
    public int setMaxHealth() { return this.MAX_HEALTH; }
    ...
    public void movePlayer(String direction) {
        ...
        // If this room has a puzzle, trigger it
